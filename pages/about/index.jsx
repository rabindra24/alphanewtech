  ...
  return (
    <Stairs>
      <div className="relative top-0 ">
        <div className="headerImage h-screen w-full relative top-0 ">
          <div className="workBackground h-screen opacity-60 w-full flex items-center justify-center"></div>
        ...
        <div className="relative top-0 space-y-20">
          {/* //backgrond line  */}
          <div className=" w-full h-full absolute top-0 left-0 -z-10 flex bg-white ">
            {[1, 1, 1, 1, 1].map((item) => (
              <div className="w-full border-[0.1px] border-gray-100 border-t-0 border-b-0 "></div>
            ))}
          </div>
          {/* ///Services 02*/}
          <div className="w-full h-full  md:px-10 px-5 py-10 relative z-10">
              ...
              <div className="flex md:flex-row flex-col gap-6">
                <div className="flex-1">
                  ...
                  <p className="text-gray-600 font-pontiac md:text-xl text-md tracking-wider">
                    ...
                    based on scalable backend solutions (Python, Java, Node.js,
                    Golang), and JavaScript (React, Angular) on the frontend, as
                    well as mobile apps accessible on Android & iOS devices
          ...
          <div className="w-full h-full  md:px-10 px-5 py-10 relative z-10">
            <div className="flex flex-col ">
              <div className="flex md:flex-row flex-col px-2 gap-6 ">
                <div className="flex-1">
                  <h4 className="text-gray-900 text-4xl md:text-6xl mb-7">
                    03. our values
                  </h4>
                  <p className="text-primary  font-bold text-4xl md:text-6xl font-pontiac mb-5">
                    {values.title}
            ...
            <div className="flex flex-col ">
              <div className="flex md:flex-row flex-col gap-6">
                <div className="flex-1">
                  ...
                  <p className="text-gray-600 font-pontiac md:text-xl text-md tracking-wider">
                  We believe in the power of teamwork - you need cooperation between specialists to create great projects.
                  </p>
                </div>
                <div className="flex-1 relative top-0 border-4 border-primary">
                  <video
          ...
          <div className="w-full h-full  md:px-10 px-5 py-10 relative z-10">
            <div className="flex flex-col">
              <h4 className="text-gray-900 text-2xl">O2. services</h4>
              <p className="text-primary text-2xl font-pontiac mb-2">
                our expertise
              </p>
              <div>
                <p className="text-gray-600 font-pontiac text-sm mb-5">
                  <span className="text-gray-900 font-bold">
                    We turn ideas into great digital products.
                  </span>{" "}
                  Thanks to a collaboration between unique talents,{" "}
